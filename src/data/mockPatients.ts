...
export const patients: Patient[] = [
  {
    ...
    familyMembers: [
      { id: "f1", name: "Rajesh Sharma", relation: "Son", healthId: "UHID-2024-1203-B", conditions: ["Pre-diabetes"], riskFactors: ["Type 2 Diabetes (72% risk by age 65)", "Hypertension (58% risk)"] },
      { id: "f2", name: "Priya Sharma Gupta", relation: "Daughter", healthId: "UHID-2024-1204-C", conditions: [], riskFactors: ["Type 2 Diabetes (65% risk by age 60)", "Osteoarthritis (45% risk)"] },
    ],
  ...
  },
  {
    ...
    familyMembers: [
      { id: "f3", name: "Amit Verma", relation: "Son", healthId: "UHID-2024-2301-E", conditions: ["Hypertension"], riskFactors: ["Heart Disease (68% risk by age 70)", "A-Fib (42% risk)"] },
    ],
  ...
  },
  {
    ...
    familyMembers: [
      { id: "f4", name: "Vikram Iyer", relation: "Son", healthId: "UHID-2024-3102-H", conditions: ["Pre-diabetes"], riskFactors: ["Type 2 Diabetes (78% risk by age 55)", "CKD (35% risk)"] },
      { id: "f5", name: "Meena Iyer Nair", relation: "Daughter", healthId: "UHID-2024-3103-I", conditions: [], riskFactors: ["Type 2 Diabetes (70% risk by age 60)"] },
    ],
