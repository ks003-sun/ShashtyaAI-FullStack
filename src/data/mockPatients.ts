...
export const patients: Patient[] = [
  {
    ...
    insights: [
      ...
      { id: "i47", type: "warning", title: "CBC Report — Microcytic Anemia Detected", description: "Complete Blood Picture uploaded on April 3rd reveals Hemoglobin at 10.2 g/dL (below normal 12–16 g/dL), MCV 72 fL (microcytic), and MCH 24 pg. Iron studies show serum ferritin at 15 ng/mL (depleted stores). This iron-deficiency anemia pattern in a diabetic patient on Aspirin 81mg raises concern for occult gastrointestinal blood loss — chronic low-grade GI bleeding from Aspirin use is seen in 2–4% of elderly patients. The anemia may also be contributing to the recent fatigue and blurred vision symptoms, compounding the hyperglycemia-related visual disturbance. Reticulocyte count of 1.8% suggests inadequate bone marrow compensation.", confidence: 88, date: "2024-04-04", recommendation: "Start Ferrous Sulfate 325mg BID with Vitamin C for absorption. Order stool occult blood test. If positive, refer for upper/lower GI endoscopy. Recheck CBC in 4 weeks." },
      { id: "i48", type: "info", title: "HbA1c Panel — Glycemic Control Trajectory Mapped", description: "March 2024 HbA1c panel shows a value of 8.4%, corresponding to an estimated average glucose (eAG) of 194 mg/dL — consistent with the fasting glucose trend observed in vitals monitoring (155→195 mg/dL). This confirms that the current Metformin 500mg BID monotherapy is insufficient for glycemic control. Fructosamine level at 340 μmol/L (normal <285) further validates poor 2–3 week glycemic control. Notably, the HbA1c has risen from 7.8% six months ago, indicating progressive β-cell decline typical of the natural history of T2DM in patients >75 years. The UKPDS follow-up data shows that every 1% increase in HbA1c above 7% increases microvascular complication risk by 37%.", confidence: 94, date: "2024-04-03", recommendation: "Escalate to Metformin 1000mg BID + Glimepiride 2mg. If HbA1c remains >8% in 3 months, initiate basal insulin. Order fasting lipid panel and urine microalbumin." },
    ],
    familyMembers: [
  ...
  },
  {
    ...
    insights: [
      ...
      { id: "i49", type: "critical", title: "Echocardiogram — LVEF Declined to 28%, Severe Systolic Dysfunction", description: "2D Echocardiogram report uploaded April 1st reveals left ventricular ejection fraction (LVEF) has declined from 35% (6 months ago) to 28%, crossing the critical threshold for severe systolic dysfunction (LVEF <30%). Left atrial diameter has increased to 4.8 cm (normal <4.0 cm) indicating chronic volume overload and atrial remodeling consistent with persistent atrial fibrillation. Mild-to-moderate mitral regurgitation (Grade II) detected with regurgitant volume ~35 mL/beat, likely secondary to annular dilation from LV remodeling. E/A ratio is 2.4 with elevated E/e' of 18, confirming Grade III diastolic dysfunction (restrictive filling). Estimated pulmonary artery systolic pressure (PASP) is 52 mmHg, indicating pulmonary hypertension secondary to left heart failure. The tricuspid annular plane systolic excursion (TAPSE) at 14 mm suggests early right ventricular dysfunction — a harbinger of biventricular failure.", confidence: 93, date: "2024-04-02", recommendation: "Urgent cardiology review for advanced HF therapies. Add Sacubitril/Valsartan (Entresto) 24/26mg BID if BP tolerates. Consider ICD implantation given LVEF <30%. Evaluate for cardiac resynchronization therapy (CRT). Serial echocardiography in 3 months." },
      { id: "i50", type: "warning", title: "ECG Data — 23% Increased Risk of Arrhythmia from Tachycardia", description: "12-Lead ECG recorded April 4th shows ventricular rate of 98 bpm with irregularly irregular R-R intervals confirming ongoing atrial fibrillation with rapid ventricular response (RVR). Corrected QT interval (QTc) measured at 482 ms — borderline prolonged (normal <470 ms in males). Two runs of non-sustained ventricular tachycardia (NSVT) comprising 4–6 beat salvos at 150 bpm were captured on the rhythm strip. Using the validated CHARGE-AF risk model combined with the NSVT burden, the AI engine calculates a 23% increased relative risk of sustained ventricular arrhythmia over the next 90 days. The concurrent electrolyte derangement risk from Furosemide (hypokalemia, hypomagnesemia) further amplifies arrhythmogenic substrate. Metoprolol 25mg BID is clearly insufficient for rate control in this clinical context.", confidence: 89, date: "2024-04-05", recommendation: "Stat serum K+, Mg2+, and Ca2+. Increase Metoprolol to 50mg BID or add Digoxin 0.125mg for rate control. 48-hour Holter monitor to quantify NSVT burden. If QTc >500ms, discontinue any QT-prolonging agents. Electrophysiology consultation for ICD evaluation." },
    ],
    familyMembers: [
  ...
  },
  {
    ...
    insights: [
      ...
      { id: "i51", type: "positive", title: "Brain MRI — Meningioma Tumor Shrunk 2.6% Over Last Week", description: "Contrast-enhanced Brain MRI dated March 25th compared with the follow-up non-contrast CT Head on April 2nd reveals a measurable reduction in the right frontal convexity meningioma. Maximum diameter decreased from 1.54 cm to 1.50 cm, representing a 2.6% volumetric reduction calculated via ellipsoid approximation (4/3πabc). The tumor margins remain well-circumscribed with a smooth dural tail sign, consistent with WHO Grade I (benign) meningioma. No surrounding edema, midline shift, or mass effect on the frontal horn of the lateral ventricle. The adjacent brain parenchyma shows normal signal intensity with preserved sulcal pattern. This trajectory suggests either spontaneous regression (reported in 5–10% of incidental meningiomas) or response to the conservative watchful-waiting approach adopted 8 months ago. Serial imaging confirms no evidence of calcification, necrosis, or hemorrhagic transformation.", confidence: 86, date: "2024-04-03", recommendation: "Continue surveillance with contrast MRI every 6 months. No surgical intervention needed at current trajectory. If tumor grows >3mm in any dimension, refer to neurosurgery. Annual ophthalmology review for papilledema screening." },
    ],
    familyMembers: [],
  ...
  },
  {
    ...
    insights: [
      ...
      { id: "i52", type: "critical", title: "Coronary CT Angiography — LAD 72% Stenosis, Vulnerable Plaque Morphology", description: "Coronary CTA dated March 30th reveals a high-grade stenosis of 72% in the proximal left anterior descending (LAD) artery at the bifurcation with the first diagonal branch. Plaque composition analysis using Hounsfield unit (HU) mapping shows a predominantly lipid-rich necrotic core (HU 30–60) with a thin fibrous cap measuring <65 μm — meeting the radiographic criteria for a thin-cap fibroatheroma (TCFA), the hallmark of a 'vulnerable plaque' prone to rupture. Positive remodeling index of 1.14 (>1.1 indicates outward plaque growth) further elevates the risk of acute coronary syndrome (ACS). The right coronary artery (RCA) shows mild 30% stenosis with calcified stable plaque. Left circumflex (LCx) is patent. Agatston calcium score is 485 (75th percentile for age/sex), indicating significant atherosclerotic burden. The current Clopidogrel + Rosuvastatin regimen needs intensification.", confidence: 91, date: "2024-04-01", recommendation: "Urgent interventional cardiology referral for possible PCI/stenting of LAD lesion. Increase Rosuvastatin to 40mg for plaque stabilization. Add Ezetimibe 10mg if LDL >70 mg/dL. Functional ischemia testing (stress echo or FFR) to quantify hemodynamic significance." },
      { id: "i53", type: "warning", title: "Stress Echocardiogram — Inducible Ischemia in LAD Territory", description: "Stress echocardiogram performed April 3rd shows normal resting wall motion with LVEF 52% at baseline. During peak dobutamine stress (target HR achieved at 142 bpm), new hypokinesis was detected in the mid-anterior and anteroseptal segments — corresponding to the LAD perfusion territory identified on CTA. The wall motion score index (WMSI) worsened from 1.0 (normal) at rest to 1.25 at peak stress, indicating moderate inducible ischemia. The patient experienced typical anginal chest tightness at stage 3 of the protocol (consistent with the caregiver-reported exercise-induced chest tightness). No significant arrhythmias were provoked during the test. Peak systolic BP was 178/96 mmHg — an exaggerated hypertensive response suggesting impaired arterial compliance. This functional data corroborates the anatomical 72% LAD stenosis from CTA and confirms hemodynamic significance.", confidence: 87, date: "2024-04-04", recommendation: "Proceed with invasive coronary angiography and FFR measurement. If FFR <0.80, PCI with drug-eluting stent recommended. Optimize anti-anginal therapy: add Isosorbide Mononitrate 30mg daily. Pre-procedural dual antiplatelet loading required." },
    ],
    familyMembers: [
  ...
  },
  {
    ...
    insights: [
      ...
      { id: "i54", type: "critical", title: "HRCT Chest — Progressive Emphysema with Bullae Formation, 18% Lung Volume Loss", description: "High-Resolution CT Chest dated April 1st reveals diffuse centrilobular emphysema predominantly affecting the upper lobes bilaterally, with new paraseptal emphysema in the lower lobes since the last imaging 6 months ago. Three new subpleural bullae identified in the right upper lobe (largest 2.3 cm) — these were absent on prior imaging and indicate accelerated parenchymal destruction. Quantitative CT densitometry using −950 HU threshold shows total emphysema index of 38% (up from 32% six months ago), representing an 18% relative increase in non-functional lung volume. Air trapping on expiratory images shows 52% of lung volume affected (normal <25%). The bronchial wall thickening ratio (WA%) is 68% in segmental bronchi, indicating concurrent chronic bronchitis component. No ground-glass opacities or consolidation to suggest acute infection. Pulmonary artery diameter is 32mm (normal <29mm), corroborating clinical cor pulmonale.", confidence: 92, date: "2024-04-02", recommendation: "Start home oxygen therapy at 2L/min continuous. Pulmonary rehabilitation program. Vaccinate against pneumococcus and influenza. If bullae >3cm, thoracic surgery consultation for bullectomy eligibility. Repeat HRCT in 6 months." },
      { id: "i55", type: "warning", title: "Pulmonary Function Test — FEV1 Declined to 32% Predicted, GOLD Stage IV", description: "PFT report dated March 29th shows FEV1 of 0.78L (32% of predicted), FVC of 2.1L (58% of predicted), and FEV1/FVC ratio of 0.37 — confirming very severe airflow obstruction (GOLD Stage IV). This represents a decline from FEV1 38% predicted measured 8 months ago, an annualized decline rate of ~90 mL/year (normal age-related decline is 25–30 mL/year). DLCO is severely reduced at 38% predicted, indicating significant gas exchange impairment consistent with the SpO2 of 85% observed clinically. Bronchodilator reversibility testing showed only 6% improvement post-salbutamol (significant reversibility requires >12%), confirming fixed airway obstruction. Lung volumes show hyperinflation with TLC 132% predicted and RV/TLC ratio 0.58, explaining the patient's barrel chest and accessory muscle use.", confidence: 89, date: "2024-04-01", recommendation: "Maximize bronchodilator therapy: add Umeclidinium/Vilanterol 62.5/25mcg inhaler. Consider Roflumilast 500mcg if frequent exacerbations. Long-term oxygen therapy mandatory given DLCO <40%. Transplant evaluation if functional status permits." },
    ],
    familyMembers: [
  ...
  },
  {
    ...
    insights: [
      ...
      { id: "i56", type: "warning", title: "Brain MRI Volumetric — 8.2% Hippocampal Atrophy Acceleration, Braak Stage IV", description: "Volumetric Brain MRI dated March 20th compared with baseline from 14 months ago reveals bilateral hippocampal volume reduction from 3.42 cm³ to 3.14 cm³ (−8.2%), exceeding the expected annual atrophy rate of 3–5% for moderate Alzheimer's disease. Medial temporal lobe atrophy (MTA) score has progressed from 2 to 3 on the Scheltens visual rating scale. Cortical thickness analysis shows significant thinning in the precuneus (−12%) and posterior cingulate cortex (−9.4%) — regions critical for episodic memory retrieval and default mode network function. White matter hyperintensity (WMH) volume on FLAIR sequences has increased by 15%, suggesting concurrent small vessel disease contributing to cognitive decline. Ventricular-brain ratio (VBR) increased from 0.28 to 0.33, indicating generalized cerebral atrophy beyond the hippocampal-specific pattern. This imaging trajectory corresponds to clinical progression from Braak Stage III to Stage IV, with neurofibrillary tangles likely extending to association cortices.", confidence: 88, date: "2024-03-22", recommendation: "Formal neuropsychological testing to quantify cognitive domains affected. Consider adding Memantine 20mg extended-release if not at maximum dose. Amyloid PET scan to confirm amyloid burden and guide prognosis discussion. Family meeting for advance care planning. Refer to Alzheimer's clinical trial registry for eligibility in anti-amyloid therapy trials." },
      { id: "i57", type: "info", title: "CBC Report — Vitamin B12 Deficiency Compounding Cognitive Decline", description: "Complete Blood Picture with differential dated April 5th reveals macrocytic anemia with MCV 104 fL (normal 80–100 fL), Hemoglobin 11.8 g/dL, and hypersegmented neutrophils on peripheral smear — classic findings of megaloblastic anemia. Serum B12 is critically low at 148 pg/mL (normal >300 pg/mL). In Alzheimer's patients, B12 deficiency is found in 10–15% of cases and directly exacerbates cognitive decline through impaired myelination and elevated homocysteine (estimated at >18 μmol/L). Methylmalonic acid (MMA) elevation would confirm functional B12 deficiency at the cellular level. The concurrent Metformin use in this patient (via Glimepiride's shared pathway) is noteworthy — while this patient is on Glimepiride, the macrocytic pattern warrants B12 supplementation regardless. Folate level at 4.2 ng/mL is borderline low, further impairing DNA synthesis in rapidly dividing cells.", confidence: 84, date: "2024-04-05", recommendation: "Start Cyanocobalamin 1000mcg IM weekly for 4 weeks, then monthly. Add Folic Acid 1mg daily. Recheck B12, MMA, and homocysteine in 8 weeks. Repeat neuropsych testing at 3 months to assess if B12 repletion improves cognitive scores." },
    ],
    familyMembers: [
  ...
  // Pediatric patient — parent as caregiver
  {
    id: "19",
    healthId: "UHID-2024-9001-P1",
    name: "Arjun Mehta",
    age: 7,
    gender: "Male",
    avatar: "AM",
    ...
    riskLevel: "medium",
    medications: [
      { name: "Insulin Lispro", dosage: "3 units", frequency: "Before meals", purpose: "Blood sugar control" },
      { name: "Insulin Glargine", dosage: "6 units", frequency: "Bedtime", purpose: "Basal insulin" },
      { name: "Salbutamol Inhaler", dosage: "100mcg", frequency: "As needed", purpose: "Asthma relief" },
    ],
    vitals: [
      { date: "2024-03-01", bloodPressureSys: 98, bloodPressureDia: 60, heartRate: 95, bloodSugar: 180, weight: 48, oxygenSat: 97 },
      { date: "2024-03-08", bloodPressureSys: 96, bloodPressureDia: 58, heartRate: 92, bloodSugar: 165, weight: 48, oxygenSat: 98 },
      { date: "2024-03-15", bloodPressureSys: 98, bloodPressureDia: 60, heartRate: 90, bloodSugar: 155, weight: 49, oxygenSat: 98 },
      { date: "2024-03-22", bloodPressureSys: 100, bloodPressureDia: 62, heartRate: 94, bloodSugar: 170, weight: 49, oxygenSat: 97 },
      { date: "2024-03-29", bloodPressureSys: 97, bloodPressureDia: 59, heartRate: 91, bloodSugar: 160, weight: 49, oxygenSat: 98 },
      { date: "2024-04-05", bloodPressureSys: 99, bloodPressureDia: 61, heartRate: 93, bloodSugar: 150, weight: 50, oxygenSat: 98 },
    ],
    insights: [
      { id: "i58", type: "warning", title: "Glycemic Variability — Pediatric T1DM Pattern", description: "Continuous glucose monitoring equivalent data shows fasting blood sugar range of 150–180 mg/dL with significant intra-day variability (coefficient of variation >36%). In pediatric T1DM, the ISPAD 2022 guidelines recommend a target glucose of 70–180 mg/dL with <25% time above range. The current carbohydrate-to-insulin ratio may need recalibration as the child grows — typical ratio for age 7 is 1 unit per 20–30g carbs, and growth spurts can acutely alter insulin sensitivity by 20–40%. HbA1c estimated at 7.8% based on average glucose.", confidence: 85, date: "2024-04-05", recommendation: "Initiate CGM (Dexcom G7 or Libre 3) for real-time glucose tracking. Adjust Lispro dosing with pediatric endocrinologist. School nurse protocol review. HbA1c recheck in 3 months." },
      { id: "i59", type: "info", title: "Asthma Control Assessment — ACT Score Monitoring", description: "Salbutamol rescue inhaler use reported 3x/week — borderline between well-controlled and not-well-controlled asthma per GINA 2023 stepwise approach. The concurrent T1DM adds complexity as hypoglycemia-induced catecholamine surges can trigger bronchospasm. Ensure spacer device is being used correctly for inhaler technique.", confidence: 78, date: "2024-04-03", recommendation: "Consider adding low-dose ICS (Fluticasone 50mcg BID) if rescue use >2x/week. Peak flow diary initiation. Allergen testing for environmental triggers." },
    ],
    familyMembers: [
      { id: "f22", name: "Priya Mehta", relation: "Mother", healthId: "UHID-2024-9002-Q1", conditions: ["Hypothyroidism"], riskFactors: [], confidenceMatrix: [] },
      { id: "f23", name: "Vikram Mehta", relation: "Father", healthId: "UHID-2024-9003-R1", conditions: [], riskFactors: ["Type 1 Diabetes (8% sibling risk)"], confidenceMatrix: [] },
    ],
    lastVisit: "2024-04-02",
    nextAppointment: "2024-04-16",
    caregiverName: "Priya Mehta (Mother)",
    doctorName: "Dr. Rithika Singh",
    recentEvents: [
      { type: "vitals_change", description: "Blood sugar spiked to 280 mg/dL after birthday party — carb miscalculation", date: "2024-04-01" },
    ],
  },
  // Young adult — post-surgical recovery
  {
    id: "20",
    healthId: "UHID-2024-9104-S1",
    name: "Sneha Krishnan",
    age: 28,
    gender: "Female",
    avatar: "SK",
    location: "Chennai, Tamil Nadu",
    conditions: ["Post-ACL Reconstruction", "Iron Deficiency Anemia"],
    riskLevel: "low",
    medications: [
      { name: "Celecoxib", dosage: "200mg", frequency: "Twice daily", purpose: "Post-surgical pain/inflammation" },
      { name: "Ferrous Fumarate", dosage: "210mg", frequency: "Once daily", purpose: "Iron supplementation" },
      { name: "Enoxaparin", dosage: "40mg", frequency: "Once daily (14 days)", purpose: "DVT prophylaxis" },
    ],
    vitals: [
      { date: "2024-03-01", bloodPressureSys: 112, bloodPressureDia: 70, heartRate: 72, bloodSugar: 88, weight: 132, oxygenSat: 99 },
      { date: "2024-03-08", bloodPressureSys: 110, bloodPressureDia: 68, heartRate: 70, bloodSugar: 86, weight: 131, oxygenSat: 99 },
      { date: "2024-03-15", bloodPressureSys: 108, bloodPressureDia: 68, heartRate: 68, bloodSugar: 85, weight: 131, oxygenSat: 99 },
      { date: "2024-03-22", bloodPressureSys: 110, bloodPressureDia: 70, heartRate: 70, bloodSugar: 87, weight: 132, oxygenSat: 99 },
      { date: "2024-03-29", bloodPressureSys: 112, bloodPressureDia: 72, heartRate: 72, bloodSugar: 88, weight: 132, oxygenSat: 99 },
      { date: "2024-04-05", bloodPressureSys: 110, bloodPressureDia: 70, heartRate: 70, bloodSugar: 86, weight: 133, oxygenSat: 99 },
    ],
    insights: [
      { id: "i60", type: "positive", title: "Post-ACL Recovery — Week 4 Milestone On Track", description: "Patient is 4 weeks post-arthroscopic ACL reconstruction (hamstring autograft). Range of motion (ROM) has progressed from 0–90° at week 1 to 0–125° currently, meeting the rehabilitation benchmark of >120° by week 4. Weight-bearing status advanced to full WB without crutches. No signs of surgical site infection (SSI), wound dehiscence, or effusion. DVT prophylaxis with Enoxaparin 40mg will conclude at day 14 post-op as per ACCP guidelines. The Celecoxib 200mg BID is providing adequate analgesia with reported pain score of 2/10 at rest.", confidence: 90, date: "2024-04-05", recommendation: "Transition to Phase 2 rehabilitation (closed kinetic chain exercises, stationary cycling). Discontinue Enoxaparin after day 14. Taper Celecoxib to 200mg QD over next week. MRI at 3 months to assess graft incorporation." },
      { id: "i61", type: "info", title: "Iron-Deficiency Anemia — Post-Surgical Recovery Impact", description: "Pre-operative Hb was 10.8 g/dL with ferritin 12 ng/mL. Intraoperative blood loss of ~200mL likely worsened the anemia. Current Ferrous Fumarate 210mg QD provides ~70mg elemental iron — absorption efficiency is ~10–15% in iron-deficient states, yielding ~7–10mg absorbed daily. Expected Hb recovery rate is 1 g/dL every 3–4 weeks. Low iron status may impair collagen synthesis and tissue healing, potentially affecting ACL graft maturation.", confidence: 82, date: "2024-04-02", recommendation: "Recheck CBC and ferritin at 6 weeks post-op. If Hb <11 g/dL, consider IV iron sucrose infusion for faster repletion. Ensure Vitamin C 500mg with iron supplement to enhance absorption. Dietary counseling for iron-rich foods." },
    ],
    familyMembers: [],
    lastVisit: "2024-04-03",
    nextAppointment: "2024-04-17",
    caregiverName: "Ravi Krishnan (Spouse)",
    doctorName: "Dr. Rithika Singh",
    recentEvents: [
      { type: "hospitalization", description: "ACL reconstruction surgery — discharged day 2 post-op", date: "2024-03-08" },
    ],
  },
  // Middle-aged — chronic disease management
  {
    id: "21",
    healthId: "UHID-2024-9205-T1",
    name: "Sanjay Patel",
    age: 45,
    gender: "Male",
    avatar: "SP",
    location: "Ahmedabad, Gujarat",
    conditions: ["Type 2 Diabetes", "Obesity (BMI 34)", "Non-Alcoholic Fatty Liver"],
    riskLevel: "medium",
    medications: [
      { name: "Semaglutide", dosage: "0.5mg", frequency: "Weekly injection", purpose: "Glucose + weight management" },
      { name: "Metformin", dosage: "1000mg", frequency: "Twice daily", purpose: "Blood sugar control" },
      { name: "Atorvastatin", dosage: "20mg", frequency: "Once daily", purpose: "Cholesterol" },
    ],
    vitals: [
      { date: "2024-03-01", bloodPressureSys: 138, bloodPressureDia: 88, heartRate: 82, bloodSugar: 195, weight: 220, oxygenSat: 97 },
      { date: "2024-03-08", bloodPressureSys: 136, bloodPressureDia: 86, heartRate: 80, bloodSugar: 185, weight: 218, oxygenSat: 97 },
      { date: "2024-03-15", bloodPressureSys: 134, bloodPressureDia: 84, heartRate: 78, bloodSugar: 175, weight: 216, oxygenSat: 97 },
      { date: "2024-03-22", bloodPressureSys: 132, bloodPressureDia: 82, heartRate: 76, bloodSugar: 168, weight: 214, oxygenSat: 98 },
      { date: "2024-03-29", bloodPressureSys: 130, bloodPressureDia: 80, heartRate: 75, bloodSugar: 160, weight: 212, oxygenSat: 98 },
      { date: "2024-04-05", bloodPressureSys: 128, bloodPressureDia: 78, heartRate: 74, bloodSugar: 155, weight: 210, oxygenSat: 98 },
    ],
    insights: [
      { id: "i62", type: "positive", title: "Semaglutide Dual Benefit — Metabolic Transformation in Progress", description: "Eight weeks into GLP-1 receptor agonist therapy: fasting glucose 195→155 mg/dL (−20.5%), weight 220→210 lbs (−4.5%), and BP 138/88→128/78 mmHg. The STEP trials demonstrated that Semaglutide achieves 12–15% weight loss at 68 weeks — the current 4.5% at 8 weeks is on trajectory. Hepatic steatosis may improve with weight loss >7% per AASLD guidelines, potentially reversing NAFLD fibrosis. Cardiovascular risk reduction via the SUSTAIN-6 trial shows 26% MACE reduction with Semaglutide in T2DM patients.", confidence: 91, date: "2024-04-05", recommendation: "Titrate Semaglutide to 1mg weekly at week 12 if tolerated. FibroScan or liver elastography at 6 months to reassess NAFLD staging. Structured exercise program (150 min/week moderate aerobic). HbA1c target <7%." },
      { id: "i63", type: "warning", title: "GI Side Effects Monitoring — Semaglutide Tolerance Phase", description: "Patient reports intermittent nausea (3 days/week) and early satiety since Semaglutide initiation — these are expected GLP-1 RA class effects occurring in 40% of patients during titration. However, if emesis occurs >2x/week or weight loss exceeds 1.5 lbs/week, dose escalation should be delayed. The concurrent Metformin 1000mg BID can compound GI symptoms. Monitoring for rare but serious pancreatitis (epigastric pain radiating to back) is warranted.", confidence: 75, date: "2024-04-03", recommendation: "Maintain Semaglutide 0.5mg for 4 more weeks before escalation. Dietary counseling: small frequent meals, avoid fatty/fried foods. If nausea intolerable, consider reducing Metformin to 500mg BID temporarily. Lipase level at next visit." },
    ],
    familyMembers: [
      { id: "f24", name: "Meera Patel", relation: "Wife", healthId: "UHID-2024-9206-U1", conditions: [], riskFactors: [], confidenceMatrix: [] },
      { id: "f25", name: "Arav Patel", relation: "Son", healthId: "UHID-2024-9207-V1", conditions: [], riskFactors: ["T2DM (45% risk by age 50)"], confidenceMatrix: [{ condition: "Type 2 Diabetes", probability: 0.45, reasoning: "Paternal T2DM at age 45 with obesity. Son age 18, BMI 26 (overweight). Lifestyle intervention recommended." }] },
    ],
    lastVisit: "2024-04-01",
    nextAppointment: "2024-04-15",
    caregiverName: "Meera Patel (Wife)",
    doctorName: "Dr. Rithika Singh",
    recentEvents: [
      { type: "vitals_change", description: "10 lbs weight loss over 8 weeks — Semaglutide response positive", date: "2024-04-05" },
    ],
  },
  // Teenager — post-surgical
  {
    id: "22",
    healthId: "UHID-2024-9308-W1",
    name: "Aadhya Reddy",
    age: 14,
    gender: "Female",
    avatar: "AR",
    location: "Hyderabad, Telangana",
    conditions: ["Post-Spinal Fusion (Scoliosis)", "Vitamin D Deficiency"],
    riskLevel: "low",
    medications: [
      { name: "Acetaminophen", dosage: "500mg", frequency: "Every 6 hours PRN", purpose: "Post-surgical pain" },
      { name: "Cholecalciferol", dosage: "60,000 IU", frequency: "Weekly", purpose: "Vitamin D repletion" },
      { name: "Calcium Carbonate", dosage: "500mg", frequency: "Twice daily", purpose: "Bone healing" },
    ],
    vitals: [
      { date: "2024-03-01", bloodPressureSys: 105, bloodPressureDia: 65, heartRate: 80, bloodSugar: 90, weight: 95, oxygenSat: 99 },
      { date: "2024-03-08", bloodPressureSys: 102, bloodPressureDia: 64, heartRate: 78, bloodSugar: 88, weight: 94, oxygenSat: 99 },
      { date: "2024-03-15", bloodPressureSys: 104, bloodPressureDia: 66, heartRate: 76, bloodSugar: 89, weight: 95, oxygenSat: 99 },
      { date: "2024-03-22", bloodPressureSys: 106, bloodPressureDia: 66, heartRate: 78, bloodSugar: 90, weight: 96, oxygenSat: 99 },
      { date: "2024-03-29", bloodPressureSys: 104, bloodPressureDia: 64, heartRate: 76, bloodSugar: 88, weight: 96, oxygenSat: 99 },
      { date: "2024-04-05", bloodPressureSys: 106, bloodPressureDia: 66, heartRate: 78, bloodSugar: 90, weight: 97, oxygenSat: 99 },
    ],
    insights: [
      { id: "i64", type: "positive", title: "Post-Spinal Fusion — Week 6 Recovery Assessment", description: "Posterior spinal fusion T4-L1 for 52° Lenke Type 1 thoracic scoliosis curve. Six-week post-op X-rays show maintained correction to 12° with no hardware loosening, rod fracture, or proximal junctional kyphosis (PJK). Neurological exam intact — ASIA E. Wound healing satisfactory with no signs of SSI. Pain has improved from 7/10 to 2/10 on Acetaminophen PRN. Patient is mobilizing independently with no brace. Return to school planned for week 8.", confidence: 92, date: "2024-04-05", recommendation: "Continue activity restrictions: no bending, lifting >5 lbs, or contact sports for 6 months. Gradual return to walking and light activities. Follow-up X-rays at 3, 6, and 12 months. Physical therapy initiation at week 8 for core strengthening." },
      { id: "i65", type: "info", title: "Vitamin D Repletion — Critical for Fusion Consolidation", description: "Baseline 25-OH Vitamin D was 14 ng/mL (deficient, <20 ng/mL). Weekly Cholecalciferol 60,000 IU loading for 8 weeks is standard repletion protocol. Adequate Vitamin D (target >30 ng/mL) is essential for spinal fusion success — studies show that Vitamin D deficiency is associated with 3.6x higher pseudarthrosis rates. Calcium 500mg BID provides substrate for callus formation at fusion sites.", confidence: 80, date: "2024-04-02", recommendation: "Recheck 25-OH Vitamin D at 8 weeks. If >30 ng/mL, transition to maintenance dose 2000 IU daily. Continue Calcium supplementation for 6 months minimum. Encourage 20 min daily sunlight exposure." },
    ],
    familyMembers: [
      { id: "f26", name: "Kavitha Reddy", relation: "Mother", healthId: "UHID-2024-9309-X1", conditions: [], riskFactors: [], confidenceMatrix: [] },
      { id: "f27", name: "Ramesh Reddy", relation: "Father", healthId: "UHID-2024-9310-Y1", conditions: ["Mild Scoliosis"], riskFactors: [], confidenceMatrix: [] },
    ],
    lastVisit: "2024-04-03",
    nextAppointment: "2024-04-24",
    caregiverName: "Kavitha Reddy (Mother)",
    doctorName: "Dr. Rithika Singh",
    recentEvents: [
      { type: "hospitalization", description: "Posterior spinal fusion surgery T4-L1 — 5-day hospital stay", date: "2024-02-22" },
    ],
  },
];
